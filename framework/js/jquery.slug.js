...
jQuery.fn.slug = function(options) {
    var settings = {
        ...
        prefix : '' // prefix for slug if slug is numeric
    };
    ...
    // http://stackoverflow.com/questions/990904/javascript-remove-accents-in-strings#answer-5912746
    ...
    makeSlug = function() {
        var slugcontent = jQuery.trim(removeDiacritics($this.val())),
        ...
        if (settings.prefix && $.isNumeric(finishedslug)) {
            jQuery('input.' + settings.slug).val(settings.prefix + finishedslug.toLowerCase());
            jQuery('span.' + settings.slug).text(settings.prefix + finishedslug.toLowerCase());
        } else {
